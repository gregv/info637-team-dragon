    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(result.size() > 0){
            for(Band b : result){
                ...
                out.println("<td width=\"25%\" valign=\"top\"><img src=\"../images/"+sTmp+".jpg\" alt=\""+b.getName()+"\" /></td>");
                ...
                out.println("<td width=\"25%\" valign=\"top\"><strong>Place of Birth</br>Formation</strong></td>");
                out.println("<td width=\"75%\"><b><i>"+b.getPlaceFormed()+"</i></b></td></tr><tr>");
                out.println("<td width=\"25%\" valign=\"top\"><strong>Influences</strong></td>");
                out.println("<td width=\"75%\"><b><i>"+b.getInfluences()+"</i></b></td></tr><tr>");
                out.println("<td width=\"25%\" valign=\"top\"><strong>Active Since</strong></td>");
                out.println("<td width=\"75%\"><b><i>"+b.getYearFormed().toString()+"</i></b></td></tr><tr>");
                ...
                if(b.getHobbies()!=null)
                    out.println("<td width=\"75%\">"+b.getHobbies()+"</td></tr><tr>");
                else
                    out.println("<td width=\"75%\"></td></tr><tr>");
